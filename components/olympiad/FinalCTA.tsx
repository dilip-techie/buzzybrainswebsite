  ...
  return (
    <section className="oly-section">
      <div className="oly-container">
        <div className="relative overflow-hidden rounded-oly-4xl bg-gradient-to-br from-oly-brand-500 via-oly-brand-600 to-oly-ink px-8 py-16 text-center sm:px-16 sm:py-20">
