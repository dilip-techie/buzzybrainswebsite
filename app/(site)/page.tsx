...
const PROGRAMS = [
  ...
  },
  {
    ...
    glow: '245,158,11',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3l9 5-9 5-9-5 9-5z" /><path d="M3 8v6c0 1.5 4 4 9 4s9-2.5 9-4V8" /></svg>
    ),
  },
  {
    id: 'ap-exams',
...
const FACULTY = [
  { name: 'Dilip Sir', subject: 'Mathematics & Physics', qualification: 'B.Tech, IIT Kanpur • MBA, IIM Ahmedabad • AIR 400', expertise: 'A meticulous, concept-first mentor who makes Foundation and Advanced Mathematics and Physics feel intuitive for JEE aspirants — 25+ years of inspiring rigorous, confident problem-solvers.', initials: 'DS', gradient: 'linear-gradient(135deg,#2563EB,#1D4ED8)' },
  { name: 'Agarwal Sir', subject: 'Chemistry & Physics', qualification: 'PhD, IIT Bombay', expertise: 'A sharp, research-trained problem-solver whose structured, exam-focused approach demystifies JEE Chemistry and Physics for even the toughest aspirants.', initials: 'AS', gradient: 'linear-gradient(135deg,#10B981,#0D9488)' },
  ...
  { name: 'Pooja Singla', subject: 'Mathematics', qualification: 'B.Tech, IIT Delhi', expertise: 'A dedicated one-to-one online mentor for Grades 6-12, building strong conceptual foundations across CBSE, ICSE, Cambridge, IGCSE, IB and Olympiad Mathematics through personalized, student-centered teaching.', initials: 'PS', gradient: 'var(--grad-purple)' },
  ...
  { name: 'Arun Sir', subject: 'Mathematics', qualification: '12+ Years Teaching Experience', expertise: 'A versatile Mathematics educator who has taught Grade 6 to 12 and Engineering Mathematics across all boards, bringing the same rigor to school curricula and Maths Olympiad coaching alike.', initials: 'AR', gradient: 'var(--grad-amber)' },
];
