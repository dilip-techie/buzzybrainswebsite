...
const FACULTY = [
  ...
  { name: 'Pooja Madam', subject: 'Mathematics', qualification: 'B.Tech, IIT Delhi', expertise: 'A dedicated one-to-one online mentor for Grades 6-12, building strong conceptual foundations across CBSE, ICSE, Cambridge, IGCSE, IB and Olympiad Mathematics through personalized, student-centered teaching.', initials: 'PM', gradient: 'var(--grad-purple)' },
