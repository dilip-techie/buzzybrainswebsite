...
export const metadata: Metadata = {
  title: 'Programming Classes (Grades 6-12) | BuzzyBrains Academy',
  description: 'Master coding with an IIT Kanpur mentor. Programming classes for Grades 6-12 aligned with CBSE, ICSE, IGCSE and IB. Python, Java, Web Development.',
