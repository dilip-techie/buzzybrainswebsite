  ...
  return (
    <div className="min-h-screen bb-page-shell">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-center gap-4 mb-8">
              <a href="/12th-board-pcm" className="text-blue-600 hover:underline font-semibold">
                Looking for PCM (Engineering)? See the PCM program →
              </a>
            </div>
            <button 
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center bg-gradient-to-r from-pink-50 to-red-50 rounded-2xl p-12 border-2 border-pink-200">
          ...
          <div className="space-y-4 mb-8">
            <a href="tel:+919850570525" className="flex items-center justify-center space-x-3 text-lg text-gray-900 hover:text-pink-600 transition">
      ...
      <CtaModal
        ...
        subtitle="Get started with your 12th PCB preparation today"
      />
    </div>
  );
}
