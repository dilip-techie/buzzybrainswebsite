...
export const metadata: Metadata = {
  title: 'AMC 8 & AMC 10 Coaching in Pune | American Mathematics Competition | BuzzyBrains Academy',
  description:
    'Dedicated AMC 8 and AMC 10 coaching in Pune for Grades 6-10. IIT-alumni mentors, batches capped at 12, real scoring strategy, and a structured path to AIME. Book a free demo class.',
