...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      "This batch is built specifically for the Session 1 window. Students who want to improve their score in the April 2027 attempt can join a separate, shorter top-up batch closer to that date — ask us about it when you enroll.",
  },
];
...
export default function MhtCetCrashCoursePage() {
  ...
  const whyChooseFeatures = [
    ...
    {
      icon: TrendingUp,
      title: 'Best-of-Two Strategy Built In',
      description: 'With two attempts now likely counting toward a best-of-two score, we plan Session 1 as the practice run it should be — and coach what to change before Session 2.',
    },
    {
      icon: Rocket,
    ...
    <div className="min-h-screen bb-page-shell">
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-8">
              High-weightage chapter triage, weekly CET-pattern mocks and best-of-two attempt strategy — built for the year MHT CET moved before boards.
            </p>
            <button
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-lg text-center">
              ...
              <p className="text-gray-500 mt-2">Finishes before the Dec 15 window opens</p>
            </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Sequenced to finish before the Dec 15, 2026 Session 1 window opens</p>
          </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-12 border-2 border-blue-200">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">⏳ Limited Seats — Batch Timed to the Dec 15 Window</h2>
