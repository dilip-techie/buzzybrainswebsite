...
import { BookOpen, Target, Users, Zap, CheckCircle, Award, Phone, Mail, MapPin, ChevronRight, Lightbulb, Brain, Rocket, TrendingUp, Trophy, Globe, Calculator, Microscope, Code, DollarSign, BookOpenCheck } from 'lucide-react';
...
export default function InternationalBoardsPage() {
  ...
  const gradientColors = activeTab === 'IGCSE' ? 'from-indigo-600 to-blue-600' : activeTab === 'IB' ? 'from-teal-600 to-cyan-600' : 'from-rose-600 to-pink-600';
  ...
  const highlightColor = activeTab === 'IGCSE' ? 'text-indigo-600' : activeTab === 'IB' ? 'text-teal-600' : 'text-rose-600';
  const borderColor = activeTab === 'IGCSE' ? 'border-indigo-600' : activeTab === 'IB' ? 'border-teal-600' : 'border-rose-600';
      ...
      <section className="relative py-24 px-4 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-gray-800 mb-4">IGCSE, IB Diploma & AP Exams</h2>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm">International board preparation with A*/Score 7/Score 5 results. Expert mentors. Small batches. Global success.</p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="/12th-board" className="hover:text-white transition">12th Board</a></li>
                <li><a href="/international-boards" className="hover:text-white transition">IGCSE/IB/AP</a></li>
