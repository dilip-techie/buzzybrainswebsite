...
const routes: { path: string; changeFrequency: ChangeFreq; priority: number }[] = [
  ...
  { path: '/10th-cbse-crash-course-pune', changeFrequency: 'weekly', priority: 0.8 },
  { path: '/10th-icse-crash-course-pune', changeFrequency: 'weekly', priority: 0.8 },
  { path: '/12th-cbse-crash-course-pune', changeFrequency: 'weekly', priority: 0.8 },
  ...
  { path: '/mock-test-planner', changeFrequency: 'monthly', priority: 0.75 },
