...
import { BookOpen, Target, Users, Zap, CheckCircle, Award, Phone, Mail, MapPin, ChevronRight, Lightbulb, Brain, Rocket } from 'lucide-react';
      ...
      <section className="relative py-24 px-4 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Create Future IITians & Doctors</h2>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm">Where Concepts Become Confidence. Where Early Foundations Create Big Futures.</p>
            </div>
            <div>
